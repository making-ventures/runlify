...
const addRefreshTokens = (system: SystemMetaBuilder) => {
  const appRefreshTokens = system.addCatalog('appRefreshTokens', 'App refresh tokens');
  ...
  const uiRefreshTokens = system.addCatalog('admRefreshTokens', 'Ui refresh tokens');
