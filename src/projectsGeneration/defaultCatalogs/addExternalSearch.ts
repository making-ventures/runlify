...
export const addExternalSearch = (system: SystemMetaBuilder) => {
  const externalSearchEntities = system.getEntitiesWithExternalSearch();
  ...
  for (const externalSearchEntity of externalSearchEntities) {
    ...
    externalSearchTrackings.setDatabase(externalSearchEntity.database)
